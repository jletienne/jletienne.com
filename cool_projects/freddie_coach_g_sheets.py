...
def get_final_sheet_row_number():
    ...
    result = sheet.values().get(spreadsheetId = '1uGwQq-lZiDGLOnG8Ir9WcNjdgnRh4I4mPT_oMQzp3Fs', range='fitbod_data!A:A').execute()
...
SPREADSHEET_ID = '1uGwQq-lZiDGLOnG8Ir9WcNjdgnRh4I4mPT_oMQzp3Fs' # Get this one from the link in browser
...
def get_last_fitbod_date():
    ...
    sheet = API.spreadsheets()
    result = sheet.values().get(spreadsheetId = '1uGwQq-lZiDGLOnG8Ir9WcNjdgnRh4I4mPT_oMQzp3Fs', range='max_fitbod_date!A2').execute()
    values = result.get('values', [])
